...
# settings
INPUT_VIDEO = "/home/hakon/Downloads/charuco_CH1_35-15.mp4"
OUTPUT_VIDEO = None # None to skip recording
# OUTPUT_VIDEO = "output/recording.avi" # where to save recording of video

OUTPUT_FRAMES = None # save frame if any tag is detected
# OUTPUT_FRAMES = "evaluation/output/positive_frames" # useful to evaluate false positives
